...
`NSFetchedResultsController` is a fundamental class of the [Core Data][1] framework used to efficiently manage data for UITableViews, UICollectionViews, and any other element that displays large amounts of data. 

## When Should I Use NSFetchedResultsController?
...
<table id="figure-1" class="core-data-versus-nskeyedarchiver">
  ...
  <tbody>
    ...
    <tr>
      <td>Memory-only Tracking</td>
      <td>non-nil</td>
      <td>nil</td>
    </tr>
    <tr>
      <td>Full Persistent Tracking</td>
      <td>non-nil</td>
      <td>non-nil</td>
    </tr>
  </tbody>
